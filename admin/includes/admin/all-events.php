...
{               ?>                                      
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center"><a href="<?php echo htmlentities($result->image1);?>">link</a></td>
                                            <td class="center"><a href="<?php echo htmlentities($result->image2);?>">link</a></td>
...
<?php if($result->Status==1)
 {?>
<a href="all-events.php?inid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Are you sure you want to disapprove this event?');"" >  <button class="btn btn-danger"> Disapprove</button>
<?php } else {?>

                                            <a href="all-events.php?id=<?php echo htmlentities($result->id);?>" onclick="return confirm('Are you sure you want to  approve this event?');""><button class="btn btn-primary"> Approve</button> 
                                            <?php } ?>
