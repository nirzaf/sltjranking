...
<div class="form-group">
 <div class="radio">
<label>
<input type="radio" name="type" id="type" value="1">Head Office
</label>
</div>
<div class="radio">
<label>
<input type="radio" name="type" id="type" value="2">District Head
</label>
<div class="radio">
<label>
<input type="radio" name="type" id="type" value="3" checked="checked">Regular Branch
</label>
</div>
</div>
